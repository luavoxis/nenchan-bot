...
input,textarea,select{width:100%;padding:4px 6px;border:1px solid #333;border-radius:0;background:#000;color:#ccc;font:13px 'Space Grotesk',monospace;margin-bottom:6px;outline:none}
input:focus,textarea:focus,select:focus{border-color:#fff}
button{padding:4px 10px;background:#fff;color:#000;border:none;border-radius:0;font:12px 'Space Grotesk',monospace;cursor:pointer}
...
.member-search{width:100%;padding:6px 8px;border:1px solid #222;background:#0a0a0a;color:#ccc;font:12px 'Space Grotesk',monospace;margin-bottom:8px;outline:none}
...
.file-label{flex:1;padding:5px 8px;background:#0a0a0a;border:1px solid #222;color:#555;font:12px 'Space Grotesk',monospace;cursor:pointer;display:flex;align-items:center;gap:6px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}
...
.modal-footer button{background:#222;color:#aaa;border:1px solid #333;padding:4px 16px;font:12px 'Space Grotesk',monospace;cursor:pointer}
...
.confirm-body input,.confirm-body select,.confirm-body textarea{width:100%;padding:5px 8px;border:1px solid #333;background:#000;color:#ccc;font:12px 'Space Grotesk',monospace;outline:none;margin:0}
...
.ban-name span{color:#555;font-size:10px;font-weight:400}
...
<button onclick="loginDiscord()" style="width:100%;padding:10px 12px;background:#5865F2;color:#fff;border:none;border-radius:4px;font:13px 'Space Grotesk',monospace;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:background .15s" onmouseover="this.style.background='#4752c4'" onmouseout="this.style.background='#5865F2'"><img src="/icons/discord.png" alt="" style="width:18px;height:18px"/>Login with Discord</button>
...
<input type="text" id="mentionSearch" placeholder="@mention - search members..." oninput="filterMentions(this.value)" onfocus="showMentionList()" style="margin:0;width:100%;padding:4px 8px;border:1px solid #222;background:#0a0a0a;color:#ccc;font:12px 'Space Grotesk',monospace;outline:none"/>
...
function confirmUnban(el){
  ...
  g("confirmBody").innerHTML="<p style='color:#888;font-size:11px'>are you sure you want to unban <b style='color:#fff'>"+esc(name)+"</b>?</p>";
