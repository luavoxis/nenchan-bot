...
.dash-roles-header .role-arrow{color:#555;font-size:9px;transition:transform .2s}
...
.role-item{display:flex;align-items:center;gap:6px;padding:4px 6px;font-size:10px;color:#aaa;border-radius:4px}
