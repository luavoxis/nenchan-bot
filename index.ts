...
.sidebar h1{font-size:15px;color:#666;text-transform:uppercase;letter-spacing:1px;margin-bottom:12px;padding:0 8px}
.sidebar button{background:none;border:none;color:#666;font:13px 'Space Grotesk',monospace;padding:7px 10px;text-align:left;cursor:pointer;border-radius:4px;transition:all .15s;display:flex;align-items:center;gap:8px}
...
h2{font-size:18px;color:#666;text-transform:uppercase;letter-spacing:1px;margin-bottom:12px;font-weight:400}
label{display:block;color:#666;font-size:18px;text-transform:uppercase;margin-bottom:2px;margin-top:6px;font-weight:600}
input,textarea,select{width:100%;padding:6px 8px;border:1px solid #333;border-radius:0;background:#000;color:#ccc;font:14px 'Space Grotesk',monospace;margin-bottom:6px;outline:none}
input:focus,textarea:focus,select:focus{border-color:#fff}
button{padding:4px 10px;background:#fff;color:#000;border:none;border-radius:0;font:13px 'Space Grotesk',monospace;cursor:pointer}
button:hover{background:#888}
.flex{display:flex;gap:4px;margin-bottom:4px}
.flex button{flex:1}
.error{color:#f44;font-size:15px;margin-bottom:4px}
.success{color:#4f4;font-size:15px;margin-bottom:4px}
...
.stat span{color:#666;font-size:18px;text-transform:uppercase;letter-spacing:.5px;font-weight:600}
.stat p{color:#fff;font-size:15px;margin-top:2px}
...
.dash-name{color:#fff;font-size:18px;font-weight:600;margin:0}
.dash-id{color:#555;font-size:18px;margin-top:2px;font-weight:600}
...
.dash-card-label{color:#666;font-size:15px;text-transform:uppercase;letter-spacing:.5px;font-weight:600}
.dash-card-val{color:#fff;font-size:18px;margin-top:1px}
.dash-card-sub{color:#555;font-size:15px;margin-top:1px;font-weight:600}
...
.dash-roles-header span{color:#666;font-size:18px;text-transform:uppercase;letter-spacing:.5px;font-weight:600}
.dash-roles-header .role-arrow{color:#555;font-size:15px;transition:transform .15s}
...
th{color:#666;font-size:18px;text-transform:uppercase;font-weight:600}
...
.modal-box p{font-size:15px;color:#888;margin-bottom:6px}
...
.role-item{display:flex;align-items:center;gap:6px;padding:3px 4px;font-size:18px;color:#aaa}
...
.msg-author{font-size:15px;font-weight:600;color:#4af}
.msg-author .msg-time{font-weight:400;color:#444;font-size:15px;margin-left:6px}
.msg-content{color:#ccc;font-size:15px;line-height:1.5;margin-top:1px;word-wrap:break-word}
.msg-ref{margin:3px 0;padding:2px 8px;border-left:2px solid #444;color:#666;font-size:15px;font-weight:600}
.msg-embed{margin:4px 0;padding:6px 8px;border-left:3px solid #444;background:#0d0d0d;border-radius:2px}
.msg-embed-title{color:#59f;font-weight:bold;font-size:15px}
.msg-embed-desc{color:#bbb;font-size:18px;margin-top:2px}
.msg-embed-author{color:#888;font-size:15px;font-weight:600}
.msg-embed-field-name{color:#888;font-size:15px;margin-top:3px;font-weight:600}
.msg-embed-field-val{color:#bbb;font-size:15px}
.msg-reactions{display:flex;gap:3px;flex-wrap:wrap;margin-top:3px}
.msg-reaction{display:inline-flex;align-items:center;gap:3px;padding:1px 5px;background:#111;border-radius:3px;font-size:15px;cursor:default}
.msg-reaction-count{font-size:15px;color:#888}
.msg-del{flex-shrink:0;color:#555;cursor:pointer;font-size:18px;padding-top:3px;opacity:0}
...
.msg-file-link{color:#59f;font-size:18px}
.msg-edited{color:#555;font-size:18px;margin-left:4px}
.drop-zone{border:1px dashed #333;padding:12px;text-align:center;color:#555;font-size:18px;cursor:pointer;transition:all .15s;margin-bottom:6px}
...
.msg-input-row button{padding:4px 12px;font-size:15px;white-space:nowrap}
.msg-bar{display:flex;gap:4px;margin-bottom:4px}
.msg-bar select{margin:0;flex:1}
.menu-toggle{display:none;position:fixed;top:8px;left:8px;z-index:50;background:#0a0a0a;border:1px solid #222;color:#888;width:32px;height:32px;font:16px 'Space Grotesk',monospace;cursor:pointer}
...
.member-name{color:#ddd;font-size:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.member-name span{color:#555;font-size:18px;font-weight:400}
.member-username{color:#555;font-size:18px}
.member-badges{display:flex;gap:3px;margin-top:2px}
.member-badge{font-size:18px;padding:1px 4px;border-radius:2px;font-weight:600;text-transform:uppercase;letter-spacing:.3px}
.badge-boost{background:#f47fff;color:#fff}
.member-roles{display:flex;gap:3px;flex-wrap:wrap;margin-top:3px}
.role-badge{font-size:15px;padding:1px 5px;border-radius:2px;background:#1a1a1a;color:#888;border:1px solid #222;white-space:nowrap;font-weight:600}
.role-group-header{font-size:18px;color:#555;text-transform:uppercase;letter-spacing:.5px;padding:12px 4px 4px;border-bottom:1px solid #1a1a1a;margin-top:4px;font-weight:600}
.role-group-header:first-child{margin-top:0}
.role-group-count{color:#333;font-weight:400}
.member-joined{color:#444;font-size:15px;flex-shrink:0;font-weight:600}
.member-search{width:100%;padding:6px 8px;border:1px solid #222;background:#0a0a0a;color:#ccc;font:13px 'Space Grotesk',monospace;margin-bottom:8px;outline:none}
...
.member-stat span{display:block;font-size:15px;color:#555;text-transform:uppercase;letter-spacing:.5px;font-weight:600}
.member-stat p{font-size:18px;color:#fff;margin-top:2px}
...
.modal-header-info h3{font-size:15px;color:#fff;margin:0}
.modal-header-info p{font-size:18px;color:#555;margin:2px 0 0}
.modal-body{padding:12px 16px}
.modal-section{margin-bottom:10px}
.modal-section-label{font-size:15px;color:#555;text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px;font-weight:600}
.modal-roles{display:flex;flex-wrap:wrap;gap:4px}
.modal-role{display:flex;align-items:center;gap:4px;font-size:18px;color:#aaa;padding:3px 6px;background:#0d0d0d;border:1px solid #222}
...
.file-label{flex:1;padding:5px 8px;background:#0a0a0a;border:1px solid #222;color:#555;font:13px 'Space Grotesk',monospace;cursor:pointer;display:flex;align-items:center;gap:6px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}
...
.modal-footer button{background:#222;color:#aaa;border:1px solid #333;padding:4px 16px;font:13px 'Space Grotesk',monospace;cursor:pointer}
...
.modal-actions button{flex:1;padding:5px 8px;font-size:18px;border:1px solid #333;background:#111;color:#aaa;cursor:pointer;font-family:'Space Grotesk',monospace}
...
.confirm-title{padding:12px 16px;font-size:18px;color:#fff;border-bottom:1px solid #222}
.confirm-body{padding:12px 16px}
.confirm-body label{display:block;color:#666;font-size:15px;text-transform:uppercase;margin-bottom:2px;margin-top:8px;font-weight:600}
.confirm-body label:first-child{margin-top:0}
.confirm-body input,.confirm-body select,.confirm-body textarea{width:100%;padding:5px 8px;border:1px solid #333;background:#000;color:#ccc;font:13px 'Space Grotesk',monospace;outline:none;margin:0}
...
.confirm-footer button{flex:1;padding:5px 10px;font-size:15px;border:1px solid #333;background:#111;color:#aaa;cursor:pointer;font-family:'Space Grotesk',monospace}
...
.dm-channel-name{color:#ddd;font-size:15px}
.dm-channel-preview{color:#555;font-size:18px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.dm-channel-time{color:#555;font-size:15px;flex-shrink:0;margin-left:auto;font-weight:600}
...
.mention-item{display:flex;align-items:center;gap:8px;padding:5px 8px;cursor:pointer;font-size:15px;color:#ccc}
...
.mention-item .m-bot{color:#5865F2;font-size:18px;text-transform:uppercase;font-weight:600;margin-left:4px}
...
.ban-name{color:#ddd;font-size:15px;font-weight:600}
.ban-name span{color:#555;font-size:18px;font-weight:400}
.ban-username{color:#555;font-size:18px}
.ban-reason{color:#f44;font-size:18px;margin-top:2px;font-weight:600}
.ban-reason::before{content:"reason: "}
.ban-unban-btn{padding:3px 10px;font-size:18px;border:1px solid #f44;background:#111;color:#f44;cursor:pointer;font-family:'Space Grotesk',monospace;flex-shrink:0;font-weight:600}
...
.timeout-name{color:#ddd;font-size:15px;font-weight:600}
.timeout-name span{color:#555;font-size:18px;font-weight:400}
.timeout-username{color:#555;font-size:18px}
.timeout-detail{font-size:18px;margin-top:2px}
.timeout-expiry{color:#ff0;font-weight:600}
.timeout-remaining{color:#aa0;font-size:15px}
.timeout-reason{color:#fa0;font-weight:600}
.timeout-reason::before{content:"reason: "}
.timeout-remove{padding:3px 10px;font-size:18px;border:1px solid #ff0;background:#111;color:#ff0;cursor:pointer;font-family:'Space Grotesk',monospace;flex-shrink:0;font-weight:600}
.timeout-remove:hover{background:#ff0;color:#000}
.mod-section-title{font-size:18px;color:#555;text-transform:uppercase;letter-spacing:.5px;padding:10px 4px 6px;border-bottom:1px solid #1a1a1a;margin-top:4px;font-weight:600;display:flex;align-items:center;gap:6px}
...
<h2 style="margin-bottom:4px;color:#eee;font-size:18px;letter-spacing:1px;font-weight:500">nenchan</h2>
<p style="color:#555;font-size:18px;margin-bottom:20px;text-transform:uppercase;letter-spacing:1.5px">admin panel</p>
<div id="loginError" style="color:#f44;font-size:15px;margin-bottom:8px;min-height:16px"></div>
<button onclick="loginDiscord()" style="width:100%;padding:10px 12px;background:#5865F2;color:#fff;border:none;border-radius:4px;font:14px 'Space Grotesk',monospace;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:background .15s" onmouseover="this.style.background='#4752c4'" onmouseout="this.style.background='#5865F2'"><img src="/icons/discord.png" alt="" style="width:18px;height:18px"/>Login with Discord</button>
<p style="color:#333;font-size:15px;margin-top:12px">authorized users only</p>
</div>
</div>
...
<input type="text" id="mentionSearch" placeholder="@mention - search members..." oninput="filterMentions(this.value)" onfocus="showMentionList()" style="margin:0;width:100%;padding:4px 8px;border:1px solid #222;background:#0a0a0a;color:#ccc;font:13px 'Space Grotesk',monospace;outline:none"/>
<div id="mentionList" class="mention-list"></div>
</div>
<div id="msgHistory" style="max-height:380px;overflow-y:auto;margin-bottom:6px;background:#0a0a0a;border:1px solid #1a1a1a;padding:4px;font-size:18px;line-height:1.5">
...
<div id="msgStatus" style="font-size:18px;margin-top:4px;min-height:14px"></div>
</div>
...
<div id="dmStart">
<p style="color:#555;font-size:18px;margin-bottom:6px">enter a user id to open dm</p>
...
<button onclick="dmClose()" style="margin:0;padding:2px 8px;background:#1a1a1a;color:#888;border:1px solid #333;font-size:15px">close</button>
<span id="dmChatName" style="color:#fff;font-size:18px"></span>
</div>
<div id="dmHistory" style="max-height:380px;overflow-y:auto;margin-bottom:6px;background:#0a0a0a;border:1px solid #1a1a1a;padding:4px;font-size:18px;line-height:1.5">
...
<div id="dmStatus" style="font-size:18px;margin-top:4px;min-height:14px"></div>
</div>
</div>
...
function loadDashboard(){
  api({action:"guildinfo"},function(d){
    if(d.error)return;
    var iconHtml=d.icon?"<img class='dash-icon' src='"+d.icon+"' alt=''/>":"<div class='dash-icon' style='display:flex;align-items:center;justify-content:center;color:#555;font-size:24px'>"+esc(d.name.charAt(0))+"</div>";
...
function loadModerations(){
  ...
  g("banTimeouts").innerHTML="<p style='color:#666;font-size:18px'>loading...</p>";
  api({action:"moderations"},function(d){
    if(d.error){g("banTimeouts").innerHTML="";g("banBans").innerHTML="<p style='color:#f44;font-size:18px'>"+esc(d.error)+"</p>";return}
...
function renderTimeouts(timeouts){
  ...
  if(!timeouts.length)h+="<div class='mod-section-title'><span class='dot' style='background:#ff0'></span>timed out</div><p style='color:#555;font-size:18px;padding:6px 0'>no active timeouts</p>";
...
function renderBans(bans){
  ...
  if(!bans.length)h+="<div class='mod-section-title'><span class='dot' style='background:#f44'></span>banned</div><p style='color:#555;font-size:18px;padding:6px 0'>no banned users</p>";
...
function confirmUnban(el){
  ...
  g("confirmBody").innerHTML="<p style='color:#888;font-size:15px'>are you sure you want to unban <b style='color:#fff'>"+esc(name)+"</b>?</p>";
...
function removeTimeout(el){
  ...
  g("confirmBody").innerHTML="<p style='color:#888;font-size:15px'>remove timeout for <b style='color:#fff'>"+esc(name)+"</b>?</p>";
  var btn=g("confirmBtn");
  btn.className="confirm-danger";
...
function loadMsgHistory(cid){
  ...
  api({action:"messages",channelId:cid,limit:30},function(d){
    ...
    try{
      for(var i=d.messages.length-1;i>=0;i--){
        ...
        if(msg.embeds&&msg.embeds.length){
          for(var j=0;j<msg.embeds.length;j++){
            ...
            if(e.footer&&e.footer.text) h+="<div style='color:#555;font-size:18px;margin-top:3px'>"+esc(e.footer.text)+"</div>";
            h+="</div>";
          }
        }
      ...
      h+="<p style='color:#f44;font-size:18px;margin-top:8px'>render error: "+esc(e.message)+"</p>";
    }
...
function showMember(id){
  ...
  g("modalBox").innerHTML="<div class='modal-header'><img src='"+avatar+"' alt='' /><div class='modal-header-info'><h3>"+esc(name)+"</h3><p>"+esc(m.user.username)+(m.user.bot?" &middot; bot":"")+"</p></div></div>"+
    ...
    "<div class='modal-section'><div class='modal-section-label'>id</div><p style='color:#aaa;font-size:15px'>"+m.user.id+"</p></div>"+
    "<div class='modal-section'><div class='modal-section-label'>joined</div><p style='color:#aaa;font-size:15px'>"+joined+"</p></div>"+
    (m.premium_since?"<div class='modal-section'><div class='modal-section-label'>boosting since</div><p style='color:#aaa;font-size:15px'>"+new Date(m.premium_since).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})+"</p></div>":"")+
    "<div class='modal-section'><div class='modal-section-label'>roles</div><div class='modal-roles'>"+(rolesHtml||"<span style='color:#555;font-size:18px'>no roles</span>")+"</div></div>"+
    "</div>"+
