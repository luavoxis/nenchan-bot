...
<div class="file-label" id="fileLabel">\u{1F4CE} attach file...</div>
</div>
...
function updateFileLabel(el){
  ...
  if(el.files&&el.files.length){label.textContent="\u{1F4CE} "+el.files[0].name;label.classList.add("has-file")}
  else{label.textContent="\u{1F4CE} attach file...";label.classList.remove("has-file")}
}
