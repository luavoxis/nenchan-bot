...
<input type="text" id="dmUserId" placeholder="user id" style="flex:1;padding:4px 6px;font-size:11px;font-family:monospace;border:1px solid #333;background:#000;color:#ccc;outline:none"/>
<button onclick="startDmById()" style="padding:4px 12px;font-size:11px;background:#333;color:#eee;border:1px solid #555;border-radius:0;cursor:pointer;font-family:monospace;line-height:1">open</button>
</div>
</div>
